...
namespace Model
{
     public class engage_resumeModel
    {
        ...
        public string human_mobilephonej { get; set; }
        ...
        public string test_check_time { get; set; }

        public string pass_register { get; set; }

        public string pass_regist_time { get; set; }

        public string pass_checker { get; set; }

        public string pass_check_time { get; set; }
